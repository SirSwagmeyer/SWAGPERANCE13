...
/obj/item/rogueweapon/scabbard/sheath/grandmaster
	name = "commander's cane"
	desc = "A decorated cane bearing the visage of a vulture."
	icon_state = "grandmastersheath"
	item_state = "grandmastersheath"
	valid_blade = /obj/item/rogueweapon/sword/rapier/grandmaster
	sellprice = 45

/obj/item/rogueweapon/scabbard/sheath/grandmaster/getonmobprop(tag)
	. = ..()
	if(tag)
		switch(tag)
			if("gen")
