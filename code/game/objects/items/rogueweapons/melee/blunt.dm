...
/obj/item/rogueweapon/mace/cudgel/blackguard
	...
	desc = "An enhanced, sleek cudgel for clandestine operations. The balance of this club is well-balanced, allowing for quicker, accurate strikes. It can be thrown like a billy club in a pinch."
	force = 25
