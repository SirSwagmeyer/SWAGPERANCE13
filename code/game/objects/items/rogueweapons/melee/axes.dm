...
/obj/item/rogueweapon/stoneaxe/battle/commandant
	name = "commandant's ćiupaga"
	desc = "A trench axe of Risvonian make that has been modified. It has a weighty, flat head that \
	fits the hand comfortably, and it's usable for chopping and smashing. It carries the colours of the Ziggurate."
