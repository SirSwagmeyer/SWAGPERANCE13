...
/obj/item/scomstone/attack_right(mob/living/carbon/human/user)
	...
	for(var/obj/item/scomstone/rislead/leader in SSroguemachine.scomm_machines)
		if(leader.faction_net == faction_net)
			leader.repeat_message(input_text, src, usedcolor)
